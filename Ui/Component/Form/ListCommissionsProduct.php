...
class ListCommissionsProduct extends DataObject implements OptionSourceInterface
{
    /**
    ...
    public function toOptionArray()
    {
        ...
        $options[] = ['value' => 'DEBITO A VISTA', 'label' => 'Débito á Vista'];
        ...
        $options[] = ['value' => 'BOLETO', 'label' => 'Boleto'];
